...
rem Ademais debe mover o ficheiro, cuxa roteiro se pasa por parámetro, ao directorio trash do usuario actual.Débese pasar por parámetro o roteiro do ficheiro para mover. Se non se pasa por parámetro ningún valor entón deberase mostrar unha mensaxe de erro e terminar co script.
